...
LIBRPLIDARSHARED_EXPORT int lidarInit(const char* portname,_u32 baudrate);
LIBRPLIDARSHARED_EXPORT int lidarStart(void);
LIBRPLIDARSHARED_EXPORT int lidarGetScanData(rplidar_response_measurement_node_t * nodes,size_t count, _u32 timeout);
